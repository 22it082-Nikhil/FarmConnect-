    ...
    return (
      <div className="fixed inset-0 z-50 bg-white overflow-auto">
        ...
        <button
          ...
          className="fixed top-4 right-4 z-50 bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg shadow-lg print:hidden"
        >
          ✕ Close
        </button>

        {/* Main Bill Content */}
        <div className="bg-white text-black font-serif max-w-[210mm] mx-auto p-4 min-h-screen box-border">
          <div className="border-2 border-black rounded-3xl min-h-[95vh] flex flex-col relative overflow-hidden">
  ...
  const renderCalendar = () => (
    <div className="space-y-6">
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        className="bg-gradient-to-r from-primary-500 to-primary-600 rounded-2xl p-6 sm:p-8 text-white flex justify-between items-center"
      >
        <div>
          <h2 className="text-2xl sm:text-3xl font-bold mb-2">Farm Calendar</h2>
          <p className="text-primary-100 text-sm sm:text-lg">Manage filed work and schedules</p>
        </div>
        <button
          onClick={() => setIsTaskModalOpen(true)}
          className="bg-white text-primary-600 px-4 py-2 sm:px-6 sm:py-3 rounded-xl font-bold shadow-lg hover:bg-primary-50 transition-all flex items-center text-sm sm:text-base"
        >
